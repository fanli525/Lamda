...
class GPHeteroscedasticRegression(GP):
    ...
    """
    def __init__(self, X, Y, kernel=None, Y_metadata=None,normalizer=False):
        ...
        super(GPHeteroscedasticRegression, self).__init__(X,Y,kernel,likelihood, Y_metadata=Y_metadata,normalizer=normalizer)
