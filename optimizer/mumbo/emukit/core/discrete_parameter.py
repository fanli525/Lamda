...
class InformationSourceParameter(DiscreteParameter):
    def __init__(self, n_sources: int) -> None:
        ...
        """
        if np.issubdtype(type(n_sources), np.integer)==False:
            super().__init__('source', list([n_sources]))

        else:
            super().__init__('source', list(range(n_sources)))

# class InformationSourceParameter(ContinuousParameter):
#     def __init__(self, name,min_value,max_value) -> None:
#         """
#         :param n_sources: Number of information sources in the problem
#         """
#         self.name=name
...
class InformationSourceParameter_fixvalue(DiscreteParameter):
    def __init__(self, n_sources: int) -> None:
        """
        :param n_sources: Number of information sources in the problem
        """
